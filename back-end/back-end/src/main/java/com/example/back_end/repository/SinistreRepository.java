...
public interface SinistreRepository extends MongoRepository<Sinistre, String> {
    ...
    List<Sinistre> findByCinUtilisateurOrderByDateIncidentDesc(String cinUtilisateur);

    List<Sinistre> findByNumeroContratInOrderByDateIncidentDesc(List<String> numerosContrat);
}
